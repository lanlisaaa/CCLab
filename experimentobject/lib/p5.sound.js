...
(function (modules) {
  ...
  ([
    ...
    (function (module, __webpack_exports__, __webpack_require__) {
      ...
      var soundfile_SoundFile =
        function () {
          ...
          soundfile_createClass(SoundFile, [{
             ...
             *    cnv.mousePressed(canvasPressed);
             *    background(220);
             *    LifelineX = constrain(mouseX, 0, width);
             *    ellipse(LifelineX, height/2, 20, 20);
             *  }
             *
             *  function canvasPressed(){
             *    // map the Lifeline's x location to a panning degree
             *    // between -1.0 (left) and 1.0 (right)
             *    let panning = map(LifelineX, 0., width,-1.0, 1.0);
       ...
       *  generate an impulse response is to pop a Lifelineoon in a reverberant space
